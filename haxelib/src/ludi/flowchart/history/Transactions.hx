...
class AddNodeWithRequiredTransaction implements Transaction {
    var graph:Graph<FlowchartNode, FlowchartConnection>;
    var nodes:Array<FlowchartNode>;
    var edges:Array<GraphConnection<FlowchartNode, FlowchartConnection>>;

    public function new(graph:Graph<FlowchartNode, FlowchartConnection>, nodes:Array<FlowchartNode>, edges:Array<GraphConnection<FlowchartNode, FlowchartConnection>>) {
        this.graph = graph;
        this.nodes = nodes;
        this.edges = edges;
    }
    ...
    public function undo() {
        ...
        for (n in nodes) graph.removeNode(n);
    }

    public function redo() {
        for (n in nodes) graph.addNode(n);
        for (e in edges) graph.addEdge(e);
    }

    public function getLabel() {
        return "Add Node with Required Nodes";
    }
}

class DeleteNodeWithRequiredTransaction implements Transaction {
    var graph:Graph<FlowchartNode, FlowchartConnection>;
    var nodes:Array<FlowchartNode>;
    var edges:Array<GraphConnection<FlowchartNode, FlowchartConnection>>;
    ...
    public function getLabel() {
        return "Delete Node with Required Nodes";
    }
}
